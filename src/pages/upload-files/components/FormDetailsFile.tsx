      ...
      <div className="flex flex-col px-7 py-4 gap-2 overflow-y-auto max-h-[63vh] lg:max-h-[63vh]">
        ...
        <div className="mb-3">
          ...
          <DatePicker
            ...
            selected={fileSelected?.data_publicacao}
            onChange={(date) => handleChange("data_publicacao", date)}
          />
        </div>
        <div className="mb-3">
          <label
        ...
        <div className="sticky bottom-[-20px] flex w-full justify-end py-2 gap-2 bg-white">
          {showCheckboxFile && (
            <Button text="Salvar" isLoading={loading} onClick={handleCancel} />
          )}
          <Button
            secondary
            text="Fechar"
