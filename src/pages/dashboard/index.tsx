...
import { formatBigNumber, formatPorcentagem } from "@/helpers";
      ...
      <div className="flex px-12 flex-col gap-3 w-full py-8">
        ...
        <div className="flex gap-4">
          <div className="flex gap-4 w-full">
            <div
              className="flex py-3 px-5 w-full bg-white items-center gap-3 rounded-lg
                cursor-pointer hover:bg-gray-100 shadow-lg"
            ...
            >
              ...
              <h2 className="text-gray-700 font-light text-lg whitespace-nowrap">
                Arquivos Enviados
              </h2>
            </div>
        ...
        <div className="flex gap-2 w-full">
          <div className="bg-white px-4 py-4 flex w-full flex-col items-center justify-center rounded-lg border">
            <h2 className="text-gray-700 font-light text-md whitespace-nowrap">
              Volume Máximo de Seguidores
            </h2>
            <h2 className="text-gray-700 font-bold text-2xl whitespace-nowrap">
              {formatBigNumber(reportData.seguidores_totais)}
            </h2>
            ...
            <div className="px-2 py-2 flex w-full justify-center items-center gap-2">
              <div className="bg-white px-4 py-4 flex w-full flex-col items-center rounded-lg shadow">
                <span className="text-gray-700 font-light text-md whitespace-nowrap">
                  Influencers
                </span>
                <span className="text-gray-700 font-bold text-md whitespace-nowrap">
                  {formatBigNumber(reportData.influencers)}
                </span>
              </div>
              ...
              <div className="bg-white px-4 py-4 flex w-full flex-col items-center rounded-lg shadow">
                ...
                <span className="text-gray-700 font-bold text-md whitespace-nowrap">
                  {formatBigNumber(reportData.publis)}
                </span>
              </div>
            </div>
          </div>
          ...
          <div className="bg-white px-4 py-4 flex w-full flex-col justify-center gap-2 items-center rounded-lg border">
            ...
            <h2 className="text-gray-700 font-light text-md whitespace-nowrap">
              Impressões/Views Totais
            </h2>
            <h2 className="text-gray-700 font-bold text-2xl whitespace-nowrap">
              {formatBigNumber(reportData.impressoes_views)}
            </h2>
          </div>
          ...
          <div className="bg-white px-4 py-4 flex w-full flex-col justify-center gap-2 items-center rounded-lg border">
            ...
            <h2 className="text-gray-700 font-light text-md whitespace-nowrap">
              Maior Alcance das Entregas
            </h2>
            <h2 className="text-gray-700 font-bold text-2xl whitespace-nowrap">
              {formatBigNumber(reportData.alcance_total)}
            </h2>
          </div>
          ...
          <div className="bg-white px-4 py-4 flex w-full flex-col gap-2 justify-center items-center rounded-lg border">
            ...
            <h2 className="text-gray-700 font-light text-md whitespace-nowrap">
              % Alcance X Seguidores
            </h2>
            <h2 className="text-gray-700 font-bold text-2xl whitespace-nowrap">
              {formatPorcentagem(reportData.alcance_seguidores)}
            </h2>
          </div>
        </div>
        <div className="flex w-full gap-2">
          <div className="bg-white px-2 gap-2 py-2 flex w-full flex-col items-center justify-center rounded-lg border">
            <div className="bg-white flex w-full flex-col items-center rounded-lg shadow px-2 py-2">
              ...
              <h2 className="text-gray-700 font-bold text-2xl whitespace-nowrap">
                {formatBigNumber(reportData.engajamento_total)}
              </h2>
            </div>

            <div className="bg-white flex w-full flex-col items-center rounded-lg shadow px-2 py-2">
              <h2 className="text-gray-700 font-light text-md whitespace-nowrap">
                Taxa de Engajamentos
              </h2>
              <h2 className="text-gray-700 font-bold text-2xl whitespace-nowrap">
                {formatPorcentagem(reportData.taxa_de_engajamento)}
              </h2>
            </div>
          </div>
          ...
          <div className="bg-white px-4 py-4 flex w-full flex-col items-center justify-center gap-2 rounded-lg border">
            ...
            <h2 className="text-gray-700 font-bold text-3xl whitespace-nowrap">
              {formatBigNumber(reportData.comentarios_total)}
            </h2>
          </div>
        </div>
        ...
        <div className="flex gap-4 w-full bg-white items-center px-4 py-4 rounded-lg border">
          <CardItem
            text="Ver Todos"
            icon={IconPaths.todos}
            onClick={() => setGraphSelected("todos")}
            isSelected={graphSelected === "todos"}
          />
          <CardItem
            text="Vídeos Curtos"
            icon={IconPaths.video_curto}
            onClick={() => setGraphSelected("video_curto")}
            isSelected={graphSelected === "video_curto"}
          />
          <CardItem
            text="Stories"
            icon={IconPaths.stories}
            onClick={() => setGraphSelected("stories")}
            isSelected={graphSelected === "stories"}
          />
          <CardItem
            text="Vídeo Longo"
            icon={IconPaths.video_longo}
            onClick={() => setGraphSelected("video_longo")}
            isSelected={graphSelected === "video_longo"}
          />
          <CardItem
            text="Outras Plataformas"
            icon={IconPaths.outros}
            onClick={() => setGraphSelected("outras_plataformas")}
            isSelected={graphSelected === "outras_plataformas"}
          />
        </div>
        ...
        {graphSelected === "todos" ? (
          <div className="w-full flex flex-col gap-12">
            <div className="w-full flex flex-col gap-2">
              ...
              <div className="flex gap-2 flex-col">
                <h1 className="text-primary text-lg mt-4">
                  {report.video_curto?.table_v1?.title}
                </h1>
              ...
              <div className="flex gap-2 flex-col">
                <h1 className="text-primary text-lg mt-4">
                  {report.video_curto?.table_v2?.title}
                </h1>
            ...
            <div className="w-full flex flex-col gap-2">
              ...
              <div className="flex gap-2 flex-col">
                <h1 className="text-primary text-lg mt-4">
                  {report.video_longo?.table_v1?.title}
                </h1>
              ...
              <div className="flex gap-2 flex-col">
                <h1 className="text-primary text-lg mt-4">
                  {report.video_longo?.table_v2?.title}
                </h1>
            ...
            <div className="w-full flex flex-col gap-2">
              ...
              <div className="flex gap-2 flex-col">
                <h1 className="text-primary text-lg mt-4">
                  {report.outras_plataformas?.table_v1?.title}
                </h1>
                {report.outras_plataformas?.table_v1?.data?.length > 0 ? (
                  <TablePlataform
                    data={report.outras_plataformas?.table_v1?.data}
                  />
                ) : (
                  <span className="text-gray-500">Não existem dados.</span>
                )}
              ...
              <div className="flex gap-2 flex-col">
                <h1 className="text-primary text-lg mt-4">
                  {report.outras_plataformas?.table_v2?.title}
                </h1>
                {report.outras_plataformas?.table_v2?.data?.length > 0 ? (
                  <TablePlataform
                    data={report.outras_plataformas?.table_v2?.data}
                  />
                ) : (
                  <span className="text-gray-500">Não existem dados.</span>
                )}
          ...
          <div>
            <div className="flex gap-2 flex-col">
              <h1 className="text-primary text-lg mt-4">
                {report[graphSelected]?.table_v1?.title}
              </h1>
            ...
            <div className="flex gap-2 flex-col">
              <h1 className="text-primary text-lg mt-4">
                {report[graphSelected]?.table_v2?.title}
              </h1>
